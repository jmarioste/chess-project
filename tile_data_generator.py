...
def start_from_dir():
    ...
    for i in range(len(chessboard_images)):
        ...
        for count, tile in tiles:
            ...
            tile_img.save(f'{fen_folder_name}/{chessboard_images[i]}-{count}.jpg')

def start_from_single_img():
    # G:/Documents/Chess/1001 Chess Exercises for Club Players/output/chessboard
    img = Image.open('/mnt/g/Documents/Chess/1001 Chess Exercises for Club Players/output/chessboard/Image-1.jpg')
